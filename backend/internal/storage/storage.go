...
func (s3 *Storage) PutObject(ctx context.Context, fileName string, file io.Reader, contentType string) error {
	info, err := s3.Client.PutObject(ctx, s3.BucketName, fileName, file, -1, minio.PutObjectOptions{ContentType: contentType})
	if err != nil {
